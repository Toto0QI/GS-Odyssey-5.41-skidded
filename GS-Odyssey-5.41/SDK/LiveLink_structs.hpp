...
public:
	...
	uint8                                         Pad_10D7[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_10D8[0x10];                                    // 0x0048(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_10D9[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_10DA[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_10DB[0x60];                                    // 0x05E0(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_10DC[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_10DD[0x10];                                    // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_10DE[0x140];                                   // 0x0000(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_10DF[0x10];                                    // 0x0010(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  Source;                                            // 0x0020(0x0010)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10E0[0x30];                                    // 0x0030(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
