...
void UTrickFeedView_C::CritStyleEvent(bool Param_IsCritical)
{
	static class UFunction* Func = nullptr;
...
// (Event, Protected, BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   Param_Multiplier                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UTrickFeedView_C::UpdateMultiplier(int32 Param_Multiplier)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Multiplier = Param_Multiplier;
...
void UTrickFeedView_C::UpdateScore(class UFortVehicleTrickSet* TrickSet, int32 Param_TotalScore)
{
	static class UFunction* Func = nullptr;
