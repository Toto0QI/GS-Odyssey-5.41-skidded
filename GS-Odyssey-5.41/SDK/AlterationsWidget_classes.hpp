...
public:
	...
	uint8                                         Pad_3344[0x2];                                     // 0x02F6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3345[0x3];                                     // 0x0309(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                Description_Padding;                               // 0x030C(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor)
	uint8                                         Pad_3346[0x4];                                     // 0x031C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
