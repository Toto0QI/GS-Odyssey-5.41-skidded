...
{
public:
	uint8                                         Pad_24EC[0x8];                                     // 0x0560(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_24ED[0x6];                                     // 0x0572(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBodySetup*>                     BodySetups;                                        // 0x0578(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_24EE[0x28];                                    // 0x0588(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
