...
public:
	...
	uint8                                         Pad_C7A[0x2];                                      // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_C7B[0x2];                                      // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_C7C[0x4];                                      // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_C7D[0xF];                                      // 0x0011(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_C7E[0x7];                                      // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_C7F[0x5];                                      // 0x0013(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
