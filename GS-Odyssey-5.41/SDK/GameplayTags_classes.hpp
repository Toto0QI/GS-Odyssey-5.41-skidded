...
public:
	...
	uint8                                         Pad_2492[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2493[0x80];                                    // 0x0028(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2494[0x68];                                    // 0x00B8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2495[0x50];                                    // 0x0140(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2496[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2497[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
