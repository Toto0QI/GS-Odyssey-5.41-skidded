...
void UAthenaTeamMemberInfo_C::DeadStateChanged(class AFortPlayerStateAthena* PS, bool Param_DeadStateChanged)
{
	static class UFunction* Func = nullptr;
...
void UAthenaTeamMemberInfo_C::MutedStateChanged(class AFortPlayerStateAthena* PS, bool Param_Muted)
{
	static class UFunction* Func = nullptr;
