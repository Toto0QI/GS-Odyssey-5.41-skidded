...
void UResults_CommanderXP_New_C::Finished__DelegateSignature()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Results_CommanderXP_New_C", "Finished__DelegateSignature");
...
void UResults_CommanderXP_New_C::Initialize(class UFortUIScoreReport* InScoreReport, class UResults_TeamTotalScore_C* Param_TeamTotalScore)
{
	static class UFunction* Func = nullptr;
