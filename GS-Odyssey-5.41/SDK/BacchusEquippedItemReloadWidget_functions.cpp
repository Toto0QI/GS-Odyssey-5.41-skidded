...
void UBacchusEquippedItemReloadWidget_C::AmmoChanged(int32 Param_MagazineAmmoCount, int32 BackupAmmoCount, int32 TotalRemaining)
{
	static class UFunction* Func = nullptr;
...
void UBacchusEquippedItemReloadWidget_C::ResourceTypeChanged(class UFortResourceItemDefinition* Item, int32 Param_ResourceCount)
{
	static class UFunction* Func = nullptr;
...
void UBacchusEquippedItemReloadWidget_C::ResourceCountChanged(int32 Param_ResourceCount)
{
	static class UFunction* Func = nullptr;
