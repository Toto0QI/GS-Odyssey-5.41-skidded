...
public:
	...
	uint8                                         Pad_53B6[0x6];                                     // 0x0272(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetOwningPurchaseWidget(class UCollectionBookPurchaseWidget_C* Param_OwningPurchaseWidget);
	void PopulateCosts(bool* Param_bHasRequiredResources);
	void PopulateError();
