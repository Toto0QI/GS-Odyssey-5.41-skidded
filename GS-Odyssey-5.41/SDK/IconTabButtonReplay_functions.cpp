...
void UIconTabButtonReplay_C::Set_Text(const class FText& Param_ButtonText)
{
	static class UFunction* Func = nullptr;
...
void UIconTabButtonReplay_C::Set_Icon(const struct FSlateBrush& Param_IconBrush)
{
	static class UFunction* Func = nullptr;
...
void UIconTabButtonReplay_C::Update_Bang_State(bool Param_bBangEnabled)
{
	static class UFunction* Func = nullptr;
