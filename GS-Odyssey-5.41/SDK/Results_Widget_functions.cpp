...
// class UResults_CommanderXP_New_C*       Param_CommanderXPNew_Widget                            (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UResults_CommanderXP_C*           Param_CommanderXPOld_Widget                            (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UResults_Widget_C::GetCommanderXPWidget(bool* UseNewWidget, class UResults_CommanderXP_New_C** Param_CommanderXPNew_Widget, class UResults_CommanderXP_C** Param_CommanderXPOld_Widget)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_CommanderXPNew_Widget != nullptr)
		*Param_CommanderXPNew_Widget = Parms.Param_CommanderXPNew_Widget;

	if (Param_CommanderXPOld_Widget != nullptr)
		*Param_CommanderXPOld_Widget = Parms.Param_CommanderXPOld_Widget;
}
