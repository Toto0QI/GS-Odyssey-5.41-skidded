...
void UAthenaCustomizationTab_C::HandleSlotHovered(EAthenaCustomizationCategory Type, const class FText& Param_HeaderText, const class FText& DescriptionText, int32 SubslotIndex)
{
	static class UFunction* Func = nullptr;
...
void UAthenaCustomizationTab_C::SetItemDetailsToDisplay(class UFortItem* InputPin, const class FText& Param_HeaderText, const class FText& DescriptionText)
{
	static class UFunction* Func = nullptr;
